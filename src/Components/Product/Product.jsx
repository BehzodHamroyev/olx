        ...
        <ProductWraper>
          <div className="row m-0">
            ...
            <div className="col-md-4">
              <div className="d-flex bg-white  w-100 justify-content-between align-items-center flex-column">
                ...
                <div className="user mt-3  py-4">
                  ...
                  <div className="row  d-flex align-items-start justify-content-center m-0 ">
                    <div className="col-3   bg-white d-flex justify-content-center img align-items-center rounded-circle">
                      <img
                ...
                <div className="locatio mt-4">
                  <div className="row bg-white m-0 py-3">
